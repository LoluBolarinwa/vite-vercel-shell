        ...
        <section className="section-1">
          ...
          <div className="main row">
            ...
            <div className="description">
              <p>
                An innovative software developer well versed in designing,
                building and deploying modern frontend and blockchain
                architecture. Looking forward to working for an organization
                that aims to build next generation of decentralized financial
                products.
              </p>
            </div>
